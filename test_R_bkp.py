...
combinationStringList = list(itertools.product(*[list(groupset), list(conditionset)]))

xl = [".".join(x) for x in combinationStringList]

['Placebo.baseline', 'Placebo.postgel', 'lowgel.baseline', 'lowgel.postgel']

print xl[3] + "-" + xl[2] + "," + xl[1] + "-" + xl[0] + "," + "(" + xl[3] + "-" + xl[2] + ")-(" + xl[1] + "-" + xl[0] + ")" + "," + xl[2] + "-" + xl[0] + "," + xl[3] + "-" +xl[1]

#lowgel.postgel-lowgel.baseline,Placebo.postgel-Placebo.baseline,(lowgel.postgel-lowgel.baseline)-(Placebo.postgel-Placebo.baseline),lowgel.baseline-Placebo.baseline,lowgel.postgel-Placebo.postgel

y = list(itertools.product(*[  [xl[3],xl[2] ], [xl[1],xl[0]]]  ))
...
['lowgel.postgel-lowgel.baseline', 'lowgel.postgel-Placebo.baseline', 'Placebo.postgel-lowgel.baseline', 'Placebo.postgel-Placebo.baseline']

y = set(itertools.product(*[  [xl[3],xl[1] ], [xl[2],xl[0]] ] )) | set(itertools.product(*[  [xl[3],xl[1] ], [xl[2],xl[0]] ] ))
print  ["-".join(x) for x in y]
